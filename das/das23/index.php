...
<body>
    ...
    <li><a href="index.php">Yuri Inc.</a></li>
      ...
      <center>
        ...
        <h1>Welcome!</h1>
        <p>In Yuri Inc. We Make Generic Devices Like Android Phones With Older Android Versions And Cool Windows Laptops!</p>
        <a href="products.php"><button class="button button5">Check Out Our Products</button></a>
     </center>
      <footer>
